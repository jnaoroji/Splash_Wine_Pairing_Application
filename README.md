...
My Task was to build a MERN Single page full- Stsck Application.This app is a wine pairing app that responds to user input to pair wine with a user's desired meal. 
