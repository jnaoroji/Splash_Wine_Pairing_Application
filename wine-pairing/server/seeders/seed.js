...
db.once('open', async () => {
  try {
    ...
    const proteins = await Protein.insertMany([
      { name: 'Choose your Protein', value:0},
    ...
    const sauces = await Sauce.insertMany([
      { name: 'Choose your Sauce', value:0},
    ...
    const wines = await Wine.insertMany([
      ...
      },
      {
        ...
        varietal:"Viognier",
        region:"Vic, AUS",
        image:"https://user-images.githubusercontent.com/122245852/260724231-a8f9e229-2f4f-4b5d-a07c-97eb3f3d1595.jpeg",
      ...
      },
      {
        ...
        region:"Tas, AUS",
        image:"https://ossa.wine/wp-content/uploads/2021/07/Ossa_GrunerVeltliner22_OnDark.jpg",
      ...
      },
      {
        ...
        region:"Bandol, FRA",
        image:"https://acellars.com.au/cdn/shop/products/image022_7e0af992-5b6b-4a5d-aec4-21359942c095_1080x.jpg?v=1645156031",
      ...
      },
      {
        ...
        varietal:"Pinot Noir",
        region:"Central Otago, NZ",
        image:"https://media.danmurphys.com.au/dmo/product/1000006343-CFMAU19-1.png?impolicy=PROD_RETINA_LG",
      ...
      },
      {
        ...
        varietal:"Grenache",
        region:"SA, AUS",
        image:"https://rusdenwines.com.au/wp-content/uploads/2018/10/Rusden-Christines-VIneyard-Grenache-NV.jpg",
      ...
      },
      {
        ...
        image:"https://media.danmurphys.com.au/dmo/product/1000002952-MOB-1.png?impolicy=PROD_RETINA_MD",
      ...
      },
      {
        ...
        varietal:"Syrah",
        region:"Hawkes Bay, NZ",
        image:"https://media.danmurphys.com.au/dmo/product/331569-1.png?impolicy=PROD_RETINA_LG",
